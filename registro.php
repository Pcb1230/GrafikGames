                ...
                <div class="row justify-content-between col-12">
                    ...
                    <div class="col-6">
                        <div class="form-check form-check-inline justify-content-around">
                            ...
                            <label class="form-check-label" for="notificaciones"> <span> Activar notificaciones</span> </label>
                    </div>
                    ...
                    <div class="form-check form-check-inline justify-content-around">
                        ...
                        <label class="form-check-label" for="revista"><span> Recibir revista digital</span></label>
                    </div>
                </div>
