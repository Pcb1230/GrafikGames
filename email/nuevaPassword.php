<?php
session_start();
require '../CONTROL/reset_codigo.php';
if(!empty($comprobar)){
?>
<!doctype html>
<html lang="es">
        ...
        <form method="POST" action="submit_new.php">
            <div class="form">
                ...
                <div class="col-12 input-box">
                    <input type="hidden" name="email" value="<?php   $email=$_SESSION['emailPassword']; echo $email;?>">
...
<?php
    ...
    header("LOCATION:reset_codigo.php?error=1");
}