  ...
  <body>
    <div class="container">
      <div class="row">
          ...
          if(isset($_GET["Error"])&& $_GET["Error"]=="1"){
            echo '<p style="color:red;justify-content:center;display:flex">No se Encontro la cuenta</p>';
          }
          if(isset($_GET["Error"])&& $_GET["Error"]=="2"){
            echo '<p style="color:green;justify-content:center;display:flex">Contraseña Enviada</p>';
          }
          if(isset($_GET["Error"])&& $_GET["Error"]=="3"){
            echo '<p style="color:green;justify-content:center;display:flex">No se pudo enviar la contraseña</p>';
          }
          ?>
        <div class="col-12 imagenGrafik1">
          ...
          <?php
                          if(isset($_GET['success'])){
                            echo '<p style="color:green">Contraseña cambiada correctamente, ya puedes iniciar sesion</p>';
                        }
          ?>
    <form action="CONTROL/ModeloControladorLogin.php" method="POST">
            <div class="form">
                ...
                <a href="email/recuperarPassword.php" style="color:white;text-decoration:none">¿Has Olvidado Tu contraseña?</a>
            </div>
        </form>
